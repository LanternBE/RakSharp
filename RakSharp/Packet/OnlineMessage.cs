...
public abstract class OnlineMessage {
    ...
    public abstract MessagesIdentifier.OnlineMessages PacketId { get; }
    ...
    protected static (T packet, byte[] buffer) Create<T>(Action<T> initialize) where T : OnlineMessage, new() {
